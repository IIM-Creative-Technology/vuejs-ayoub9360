<template>
  <div>
    <div class="articleItem">
      ...
      <button @click="openEdit">Editer</button>
      <img class="cross" src="@/assets/cross.png" alt="Croix rouge">
    </div>
    <div v-if="edit">
